...
# Ініціалізуємо менеджер куків напряму, щоб уникнути помилки зі скріншота 7d03e9f3
...
st.markdown("""
    <style>
    /* ПРИБИРАЄМО КНОПКУ SHARE ТА МЕНЮ (ТРИ КРАПКИ) */
    header {visibility: hidden; height: 0px !important;}
    #MainMenu {visibility: hidden;}
    .stAppDeployButton {display:none;}
    
    /* ПРИБИРАЄМО КНОПКУ "MANAGE APP" ТА FOOTER */
